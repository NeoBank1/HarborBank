...
const notifications_data = [
  {
    ...
    createdAt: dayjs('2024-05-07').toDate(),
    isUnRead: true,
  },
  // {
  //   id: uniqueId(),
  ...
  //   avatar: null,
  //   createdAt: dayjs('2024-05-04').toDate(),
  //   isUnRead: true,
  // },
  // {
  //   id: uniqueId(),
  ...
  // },
  {
    ...
    createdAt: dayjs('2024-05-01').toDate(),
    isUnRead: false,
  },
  {
    id: uniqueId(),
    ...
    avatar: null,
    createdAt: dayjs('2024-04-30').toDate(),
    isUnRead: true,
  },
  {
    id: uniqueId(),
    ...
    avatar: null,
    createdAt: dayjs('2024-04-27').toDate(),
    isUnRead: false,
  },
];
